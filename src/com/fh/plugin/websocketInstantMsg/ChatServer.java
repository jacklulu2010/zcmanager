...
public class ChatServer extends WebSocketServer{
	...
	public void onMessage(WebSocket conn, String message){
		...
		if(null != message && message.startsWith("FHadminqq936102123")){
			this.userjoin(message.replaceFirst("FHadminqq936102123", ""),conn);
		}if(null != message && message.startsWith("LeaveFHadminqq936102123")){
			this.userLeave(conn);
